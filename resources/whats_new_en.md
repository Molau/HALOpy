...
- Photo gallery: Photos can be uploaded, viewed, and deleted for each observation. Up to 10 photos per observation are supported. Photos are displayed in a thumbnail bar in the entry dialog; an integrated image viewer allows browsing, downloading, and deleting individual images.
