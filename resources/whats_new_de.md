...
- Fotoalbum: Zu jeder Beobachtung können Fotos hochgeladen, angesehen und gelöscht werden. Bis zu 10 Fotos pro Beobachtung sind möglich. Die Fotos werden in einer Thumbnailleiste im Eingabedialog angezeigt; ein integrierter Bildbetrachter ermöglicht das Durchblättern sowie das Herunterladen und Löschen einzelner Aufnahmen.
...
- Internationalisierung: Deutsch/Englisch aus denselben Quellen, Sprachumschaltung zur Laufzeit.
- Programmende: Kein Ende-Menü mehr; Beenden durch Schließen des Browserfensters/Tabs.
