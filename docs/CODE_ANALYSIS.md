...
| | ✅ behoben 2026-07-14: globale Funktion `window.checkDataLoaded()` in main.js, lokale Kopien aus monthly_stats.js + annual_stats.js entfernt |
| `showWarningModal()` | ~~3× (modal-utils.js global + analysis.js + monthly_stats.js lokal)~~ | ~~\~80 Zeilen~~ |
| | ✅ behoben 2026-07-14: globale `window.showWarningAndGoHome()` in modal-utils.js, lokale Kopien aus analysis.js + monthly_stats.js + annual_stats.js + monthly_report.js entfernt |
| `getParameterRange()` | ~~2× (analysis.js + observation-dialogs.js Kopie)~~ | ~~\~100 Zeilen~~ |
| | ✅ behoben 2026-07-14: globale `window.getParameterRange()` in main.js, buggy Kopie aus observation-dialogs.js entfernt (SH '?' statt '°', hardcoded GG-Regionen, fehlende Fälle) |
| `populateDayFields()` Varianten | ~~2× in analysis.js (+ `populateDayFields2()`)~~ | ~~\~160 Zeilen~~ |
| | ✅ behoben 2026-07-14: 3 parametrisierte Funktionen (`populateDayFields`, `populateFilterDayFields`, `populateFilterValue`), 6 Duplikate eliminiert |
| Observer-Dropdown-Population | ~~5× (monthly_report.js, observations.js, filter-dialog.js, observation-dialogs.js 2×)~~ | ~~\~120 Zeilen~~ |
| | ✅ behoben 2026-07-14: globale `fetchObserversDeduped()`, `populateObserverDropdown()`, `buildObserverOptionsHtml()` in main.js; lokale Kopien aus allen 4 Dateien entfernt. Bugs behoben: fehlendes escapeHtml (XSS), fehlende Deduplizierung, fehlende Sortierung, ungepaddte KK |
